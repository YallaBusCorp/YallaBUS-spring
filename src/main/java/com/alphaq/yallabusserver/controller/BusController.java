...
public class BusController {
    ...
    public List<Bus> getAllBusesByCompanyId(@RequestParam("id") int companyId) {
    ...
    @RequestMapping(value = "/company/expiredLicence", method = RequestMethod.GET)
    public List<Bus> getAllBusesThatLicenceEndSoonByCompanyId(@RequestParam("id") int companyId) {
        return busService.getAllBusesThatLicenceEndSoonByCompanyId(companyId);
    }
    ...
    public Boolean delete(@RequestParam("id") int busId) {
